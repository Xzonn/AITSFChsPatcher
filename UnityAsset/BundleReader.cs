...
namespace UnityAsset
{
    ...
    {
        public Bundle(BinaryReaderExtended reader)
        {
            reader.Position = 0;
        ...
        private void ReadHeader(BinaryReaderExtended reader)
        {
        ...
        private void ReadBlocksInfoAndDirectory(BinaryReaderExtended reader)
        {
            ...
            using (var blocksInfoReader = new BinaryReaderExtended(blocksInfoUncompresseddStream))
            {
        ...
        private void ReadBlocks(BinaryReaderExtended reader, Stream blocksStream)
        {
